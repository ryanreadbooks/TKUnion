...
public class CategoryConcreteContent {
    ...
    public List<ConcreteContent> getData() {
        return data;
    }

    public void setData(List<ConcreteContent> data) {
        this.data = data;
    }
     ...
     * 包含每一件商品所具有的属性
     */
    public static class ConcreteContent {
        /**
